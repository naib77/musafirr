...
flutter build apk --release \[app-release-v1.0.3.apk](build/app/outputs/flutter-apk/app-release-v1.0.3.apk)
      --dart-define=MASTER_OTP_ENABLED=true \
      --dart-define=MASTER_OTP=1234 \
      --dart-define=GOOGLE_MAPS_API_KEY=AIzaSyBw1uyOoZ2tS8-NS_83ov8rE3OusmmDWRM \
      --build-name=1.0.1 \
      --build-number=1 \
  && mv build/app/outputs/flutter-apk/app-release.apk build/app/outputs/flutter-apk/app-release-v1.0.3.apk
