        ...
        child: ListView(
          children: [
            ...
            SwitchListTile(
              ...
              subtitle: const Text('Receive all notifications from Musaafir'),
              secondary: Icon(
            ...
            Padding(
              ...
              child: Text(
                'How often Musaafir may remind you to review completed stays '
            ...
            if (_preferences.globalEnabled) ...[
              ...
              _CategoryTile(
                ...
                onChanged: (prefs) {
                  _updatePreferences(
                      _preferences.updateCategory('booking', prefs));
                },
              ),
              ...
              _CategoryTile(
                ...
                onChanged: (prefs) {
                  _updatePreferences(
                      _preferences.updateCategory('payment', prefs));
                },
              ),
              ...
              _CategoryTile(
                ...
                onChanged: (prefs) {
                  _updatePreferences(
                      _preferences.updateCategory('message', prefs));
                },
              ),
              ...
              _CategoryTile(
                ...
                onChanged: (prefs) {
                  _updatePreferences(
                      _preferences.updateCategory('review', prefs));
                },
              ),
              ...
              _CategoryTile(
                ...
                onChanged: (prefs) {
                  _updatePreferences(
                      _preferences.updateCategory('system', prefs));
                },
              ),
  ...
  void _toggleChannelForAll(NotificationChannel channel, bool enabled) {
    ...
    for (final entry in _preferences.categoryPreferences.entries) {
      final currentChannels =
          Set<NotificationChannel>.from(entry.value.channels);
      if (enabled) {
        currentChannels.add(channel);
      } else {
        currentChannels.remove(channel);
      }
      newCategoryPrefs[entry.key] =
          entry.value.copyWith(channels: currentChannels);
    }

    _updatePreferences(
        _preferences.copyWith(categoryPreferences: newCategoryPrefs));
  }
